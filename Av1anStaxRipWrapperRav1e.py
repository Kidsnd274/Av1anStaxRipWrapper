...
parser.add_argument('-i', dest="input", type=str, required=True, help="Input File (for StaxRip)")
parser.add_argument('-o', dest="output", type=str, required=True, help="Output File (for StaxRip)")
parser.add_argument('-t', dest="tempdir", type=str, required=True, help="Temp Directory (for StaxRip)")
